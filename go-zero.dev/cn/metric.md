...
[go-zero](https://github.com/zeromicro/go-zero) 框架中集成了基于prometheus的服务指标监控，下面我们通过go-zero官方的示例[shorturl](https://github.com/zeromicro/zero-doc/blob/main/doc/shorturl.md)来演示是如何对服务指标进行收集监控的：
